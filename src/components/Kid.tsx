/*
Karakter "kid" duduk (Sitting). Avatar lengkap bertekstur: mata, bulu mata,
rambut, pakaian — material asli semua, jadi tidak perlu diwarnai / dibuat mata
manual. Dibersihkan dari gltfjsx + auto-play klip 'mixamo.com'.
*/
